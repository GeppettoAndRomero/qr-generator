...
const RUNTIME_CACHE = 'qr-generator-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/qr-generator/',
  '/qr-generator/manifest.json',
  '/qr-generator/icon-192.png',
  '/qr-generator/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/qr-generator/manifest.json';
}
