...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/qr-generator/sw.js, scope=/qr-generator/）。
    // scope がツールの全 locale ページ（/qr-generator/, /qr-generator/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/qr-generator/sw.js', {
      scope: '/qr-generator/',
    });
