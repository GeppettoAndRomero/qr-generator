...
export const ui = {
  en: {
    ...
    modeTablistLabel: 'What to encode',
    tabText: 'Text or URL',
    tabWifi: 'Wi-Fi network',
    inputHeadingWifi: 'Enter Wi-Fi network details',
    inputSubtitleWifi:
      'Fill in the network name and password. It is built into a Wi-Fi QR code entirely on your device, exactly like the text mode — nothing is uploaded.',
    wifiSsidLabel: 'Network name (SSID)',
    wifiSsidPlaceholder: 'e.g. MyHomeWiFi',
    wifiSecurityLabel: 'Security',
    wifiSecurityWpaLabel: 'WPA / WPA2 / WPA3',
    wifiSecurityWepLabel: 'WEP',
    wifiSecurityNopassLabel: 'None (open network)',
    wifiPasswordLabel: 'Password',
    wifiPasswordPlaceholder: 'Network password',
    showPassword: 'Show password',
    hidePassword: 'Hide password',
    wifiHiddenLabel: 'Hidden network (SSID not broadcast)',
    previewEmptyWifi: 'Enter a network name (and password, if any) above to generate a Wi-Fi QR code.',
    wifiPreviewAria: 'Generated Wi-Fi QR code',
  ...
  ja: {
    ...
    modeTablistLabel: 'エンコードする内容',
    tabText: 'テキスト・URL',
    tabWifi: 'Wi-Fi 接続',
    inputHeadingWifi: 'Wi-Fi 接続情報を入力',
    inputSubtitleWifi:
      'ネットワーク名とパスワードを入力してください。テキストモードと同様、端末内だけで Wi-Fi 用 QR コードに変換されます — どこにもアップロードされません。',
    wifiSsidLabel: 'ネットワーク名（SSID）',
    wifiSsidPlaceholder: '例: MyHomeWiFi',
    wifiSecurityLabel: '暗号化方式',
    wifiSecurityWpaLabel: 'WPA / WPA2 / WPA3',
    wifiSecurityWepLabel: 'WEP',
    wifiSecurityNopassLabel: 'なし（オープンネットワーク）',
    wifiPasswordLabel: 'パスワード',
    wifiPasswordPlaceholder: 'ネットワークのパスワード',
    showPassword: 'パスワードを表示',
    hidePassword: 'パスワードを隠す',
    wifiHiddenLabel: 'ステルス SSID（SSID を通知しないネットワーク）',
    previewEmptyWifi: '上にネットワーク名（とパスワード）を入力すると Wi-Fi 用 QR コードが生成されます。',
    wifiPreviewAria: '生成された Wi-Fi 用 QR コード',
  ...
  zh: {
    ...
    modeTablistLabel: '要编码的内容',
    tabText: '文本或网址',
    tabWifi: 'Wi-Fi 网络',
    inputHeadingWifi: '输入 Wi-Fi 网络信息',
    inputSubtitleWifi: '填写网络名称和密码。它会像文本模式一样完全在你的设备上编码成 Wi-Fi 二维码——不会上传到任何地方。',
    wifiSsidLabel: '网络名称（SSID）',
    wifiSsidPlaceholder: '例如 MyHomeWiFi',
    wifiSecurityLabel: '加密方式',
    wifiSecurityWpaLabel: 'WPA / WPA2 / WPA3',
    wifiSecurityWepLabel: 'WEP',
    wifiSecurityNopassLabel: '无（开放网络）',
    wifiPasswordLabel: '密码',
    wifiPasswordPlaceholder: '网络密码',
    showPassword: '显示密码',
    hidePassword: '隐藏密码',
    wifiHiddenLabel: '隐藏网络（不广播 SSID）',
    previewEmptyWifi: '在上方输入网络名称（以及密码，如有）即可生成 Wi-Fi 二维码。',
    wifiPreviewAria: '生成的 Wi-Fi 二维码',
    textLabel: '文本或网址',
  ...
  de: {
    ...
    modeTablistLabel: 'Was codiert werden soll',
    tabText: 'Text oder URL',
    tabWifi: 'WLAN-Netzwerk',
    inputHeadingWifi: 'WLAN-Zugangsdaten eingeben',
    inputSubtitleWifi:
      'Gib den Netzwerknamen und das Passwort ein. Beides wird genau wie im Textmodus vollständig auf deinem Gerät in einen WLAN-QR-Code umgewandelt — nichts wird hochgeladen.',
    wifiSsidLabel: 'Netzwerkname (SSID)',
    wifiSsidPlaceholder: 'z. B. MyHomeWiFi',
    wifiSecurityLabel: 'Verschlüsselung',
    wifiSecurityWpaLabel: 'WPA / WPA2 / WPA3',
    wifiSecurityWepLabel: 'WEP',
    wifiSecurityNopassLabel: 'Keine (offenes Netzwerk)',
    wifiPasswordLabel: 'Passwort',
    wifiPasswordPlaceholder: 'Netzwerkpasswort',
    showPassword: 'Passwort anzeigen',
    hidePassword: 'Passwort verbergen',
    wifiHiddenLabel: 'Verstecktes Netzwerk (SSID wird nicht gesendet)',
    previewEmptyWifi: 'Gib oben einen Netzwerknamen (und ein Passwort, falls vorhanden) ein, um einen WLAN-QR-Code zu erzeugen.',
    wifiPreviewAria: 'Erzeugter WLAN-QR-Code',
  ...
  es: {
    ...
    modeTablistLabel: 'Qué codificar',
    tabText: 'Texto o URL',
    tabWifi: 'Red Wi-Fi',
    inputHeadingWifi: 'Introduce los datos de la red Wi-Fi',
    inputSubtitleWifi:
      'Escribe el nombre de la red y la contraseña. Se convierten en un código QR de Wi-Fi por completo en tu dispositivo, igual que en el modo de texto: no se sube nada a ningún sitio.',
    wifiSsidLabel: 'Nombre de la red (SSID)',
    wifiSsidPlaceholder: 'p. ej. MyHomeWiFi',
    wifiSecurityLabel: 'Seguridad',
    wifiSecurityWpaLabel: 'WPA / WPA2 / WPA3',
    wifiSecurityWepLabel: 'WEP',
    wifiSecurityNopassLabel: 'Ninguna (red abierta)',
    wifiPasswordLabel: 'Contraseña',
    wifiPasswordPlaceholder: 'Contraseña de la red',
    showPassword: 'Mostrar contraseña',
    hidePassword: 'Ocultar contraseña',
    wifiHiddenLabel: 'Red oculta (SSID no difundido)',
    previewEmptyWifi: 'Escribe arriba un nombre de red (y una contraseña, si la tiene) para generar un código QR de Wi-Fi.',
    wifiPreviewAria: 'Código QR de Wi-Fi generado',
